import { KeyBindingAction, KeyBindings } from "../models/types";
...
export class KeyBindingManager {
  ...
  public updateBinding(actionId: keyof KeyBindings, key: string): void {
    ...
    if (conflictingAction) {
      console.warn(
        `Key '${key}' is already bound to '${conflictingAction[0]}'. Swapping bindings.`,
      );
      // Swap the bindings
      this.keyBindings[conflictingAction[0] as keyof KeyBindings] =
        this.keyBindings[actionId];
    }
